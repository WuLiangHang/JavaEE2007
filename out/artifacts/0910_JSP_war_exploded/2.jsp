...
<div id="header">
    ...
    <div>
        <a href="pages/user/login.html" class="btn btn-lg btn-info">登录</a> |
        <a href="pages/user/regist.html" class="btn btn-lg btn-info">注册</a> &nbsp;&nbsp;
        <a href="pages/cart/cart.html" class="btn btn-lg btn-info">购物车</a>
        <a href="pages/manager/manager.html" class="btn btn-lg btn-info">后台管理</a>
    </div>
</div>
<div id="main">
    <div id="shop">
